...
-->
<head>
  <title> ioctl.org : jsprolog </title>
...
<h1>
	<img class="right" width="100" height="76" src="/images/raven.png" alt="raven" />
	ioctl
</h1>

<p>	Prolog in JavaScript.
</p>

<div class="bc"><a href="/">ioctl.org</a> : <a href="./">logic programming</a> :
	<a href="prolog-latest">Prolog in JavaScript</a></div>

<h1> Prolog in Javascript </h1>

<p>	Here we collect the accumulated library functions of the previous versions.
</p>

<p>	This prolog is enhanced with the JavaScript callout capability though
	a rudimentary external/3 call; see the arithmetic functions for examples.
</p>

<h2> Licensing and so on </h2>

<p> These days the kids are all about the licenses. I typically get a request
	or two every year from a keen undergrad who wants to turn this into
	something interesting. Consider this code to be under a two-clause
	(non-advertising) BSD-style license.
</p>

<p>	Having said that... I'm always interested to hear what people are up to
	with this, so if you feel keen or want a natter, drop me a line:
	logic@ioctl.org. I think that ideas are more important than kudos,
	but if you want to credit then I won't blush (and I'm sure my employer
	at the time I wrote this, the University of Bristol, wouldn't mind
	you mentioning them).
</p>
